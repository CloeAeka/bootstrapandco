                                ...
                                <div class="card">
                                    <div class="col-1">
                                        <div class="d-flex flex-column thumbnails">
                                            <div id="f1" class="tb tb-active"> <img class="thumbnail-img fit-image" src="<?php echo $data["photo1"]; ?>"> </div>
                                            <div id="f2" class="tb"> <img class="thumbnail-img fit-image" src="<?php echo $data["photo2"]; ?>"> </div>
                                            <div id="f3" class="tb"> <img class="thumbnail-img fit-image" src="<?php echo $data["photo3"]; ?>"> </div>
                                            <div id="f4" class="tb"> <img class="thumbnail-img fit-image" src="<?php echo $data["photo4"]; ?>"> </div>
                                        </div>
                                    </div>
                                    <div class="col-11">
                                        <fieldset id="f11" class="active">
                                            <div class="product-pic"> <img class="pic0 img-fluid" src="<?php echo $data["photo1"]; ?>"> </div>
                                        </fieldset>
                                        <fieldset id="f21" class="">
                                            <div class="product-pic"> <img class="pic0 img-fluid" src="<?php echo $data["photo2"]; ?>"> </div>
                                        </fieldset>
                                        <fieldset id="f31" class="">
                                            <div class="product-pic"> <img class="pic0 img-fluid" src="<?php echo $data["photo3"]; ?>"> </div>
                                        </fieldset>
                                        <fieldset id="f41" class="">
                                            <div class="product-pic"> <img class="pic0 img-fluid" src="<?php echo $data["photo4"]; ?>"> </div>
                                        </fieldset>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                    <div class="row ">
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <div class="row">
                                <div class="col-4">
                                    <h2>$<?php echo $data["prix_promo"]; ?> <span class="redbox"><?php echo $pourcentage; ?>% OFF</span> </h2>
                                </div>
                                <div class="col-4 text-start align-content-around">
                                    <p class="pricegrey"><?php echo $data["quantity"]; ?> pieces left</p>
                                </div>
                        ...
                        <p class="priceline">$<?php echo $data["prix"]; ?></p>
                        ...
                        <div class="col-4 text-end">
                            <div class="dropdown">
                                <select class="form-select" aria-label="Default select example">
                                    <option selected value="1">1 pièce</option>
                                    ...
                                    <div class="col-4">
                                        <div class="card" style="width: 10rem;">
                                            <a href="https://williamg.promo-57.codeur.online/FashionUinity/Productpage.php" >
                                                <img src="<?= WEBROOT?>assets/images/image/Robe1.png" class="card-img-top" alt="...">
                                                <div class="card-body">
